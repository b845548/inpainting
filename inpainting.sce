...
function [save_pixels] = similarity(pixels,pixels_w,pixels_h,zone_size,contour_x,contour_y,patch,patch_w,patch_h,color_format,search_facteur)
	save_pixels = []  // MAT W * H
...
function repaint(path,original,save_path, patch, zone,facteur, mask_x, mask_y, mask_w, mask_h)
pixels=imread(path) 
pixels_original=imread(original) 
[pixels_h,pixels_w,color_format]=size(pixels) 
patch_w=patch
patch_h=patch
stop=1
...
matched=similarity(pixels,pixels_w,pixels_h, zone, x, y,patch_1,patch_w,patch_h,color_format,facteur)
pixels=coloring(matched,pixels,x, y,patch_w,patch_h,color_format,12);
imshow([pixels_original,pixels])
end
...
function []=fenetre_graphique(h)
    ...
    texte_b5 = uicontrol(h, "style", "text", ...
        "string", " Result path : ", ...
        "fontsize", 14, ...
        "position", [50+X 60+Y 400+L 30]);
    N9 = uicontrol(h, "style", "edit", ...
        "string",   "./result.jpg",...
        "fontsize", 14, ...
        "position", [150+X 60+Y 320 30]);
    ...
    N10 = uicontrol(h, "style", "edit", ...
        "string", "./pivert-jmp2.jpg", ...
        "fontsize", 14, ...
        "position", [150+X 120+Y 320 30]);
    bouton = uicontrol(h, "string", "Repainting",...
        "position", [130+X 30+Y 80 30], ...
        "userdata", [N1, N2, N3, N4, N5, N6, N7, N8, N9,N10], ...
        "callback", "path = gcbo.userdata(1).string;"+ ...
                    ...
                    "org = gcbo.userdata(10).string;" + ...
                    "repaint(path,org,save,patch, zone,facteur,X,Y,W,H);");
   bouton2 = uicontrol(h, "string", "Masking",...
        "position", [50+X 30+Y 80 30], ...
        "userdata", [N1, N2, N3, N4, N5, N6, N7,N9], ...
        "callback", "path = gcbo.userdata(1).string;"+ ...
                    "patch = eval(gcbo.userdata(2).string);" + ...
                    "zone = eval(gcbo.userdata(3).string);"+ ...
                    "X = eval(gcbo.userdata(4).string);" + ...
                    ...
                    "W = eval(gcbo.userdata(6).string);" + ...
                    "H = eval(gcbo.userdata(7).string);"+ ...
   					"save = gcbo.userdata(8).string;"+ ...
                    "remplisage(path,save,X,Y,W,H);");
  
    bouton3 = uicontrol(h, "string", "Debuging",...
        "position", [210+X 30+Y 80 30], ...
